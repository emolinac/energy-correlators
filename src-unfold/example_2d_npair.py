...
h4,h4bins,_ = ax1.hist(theta0_G[:,var_id]       ,weights=myweights[niterations-1, 1, :], bins=np.linspace(0.00999,0.5,15),color='black',histtype="step",label="OmniFolded",lw="2")
