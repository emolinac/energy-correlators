...
void macro_print_roounfold_closuretest_3d(int Niter = 5, double jet_pt_min_local = unfolding_jetpt_binning[0], double jet_pt_max_local = unfolding_jetpt_binning[5])
{
    ...
    TH3D* htrue_ref = new TH3D("htrue_ref","",Nbin_R_L+2,unfolding_rl_binning,Nbin_jet_pt+2,unfolding_jetpt_binning,Nbin_weight,weight_binning);
    ...
    // TH2D* htrue_ref_rl_jetpt       = new TH2D("htrue_ref_rl_jetpt"      ,"",Nbin_R_L+2,unfolding_rl_binning,Nbin_jet_pt+2,unfolding_jetpt_binning);
    // TH2D* hunfolded_bayes_rl_jetpt = new TH2D("hunfolded_bayes_rl_jetpt","",Nbin_R_L+2,unfolding_rl_binning,Nbin_jet_pt+2,unfolding_jetpt_binning);
    ...
    TH2D* hunfolded_bayes_rl_jetpt = (TH2D*) hunfolded_bayes->Project3D("xy");
    TH2D* htrue_ref_rl_jetpt       = (TH2D*) htrue_ref->Project3D("xy");
