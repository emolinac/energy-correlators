...
void macro_print_fullcorre2c_paircorr_2dunf_ct(int niter = 4, bool do_print = true, bool compare_to_nominal = false, bool compare_to_truth = true)
{
    ...
    TH2D* hpurcorr_l = new TH2D("hpurcorr_l","",nbin_rl_unfolding,unfolding_rl_binning,nbin_jet_pt_unfolding,unfolding_jetpt_binning);
    TH2D* hmeas_l    = new TH2D("hmeas_l"   ,"",nbin_rl_unfolding,unfolding_rl_binning,nbin_jet_pt_unfolding,unfolding_jetpt_binning);
    TH2D* htrue_l    = new TH2D("htrue_l"   ,"",nbin_rl_unfolding,unfolding_rl_binning,nbin_jet_pt_unfolding,unfolding_jetpt_binning);
    ...
    TH2D* hunfolded_ratio_l   = new TH2D("hunfolded_ratio_l"  ,"",nbin_rl_unfolding,unfolding_rl_binning,nbin_jet_pt_unfolding,unfolding_jetpt_binning);
    TH2D* hpuritycorrected_l  = new TH2D("hpuritycorrected_l" ,"",nbin_rl_unfolding,unfolding_rl_binning,nbin_jet_pt_unfolding,unfolding_jetpt_binning);
    TH2D* hpuritycorrected2_l = new TH2D("hpuritycorrected2_l","",nbin_rl_unfolding,unfolding_rl_binning,nbin_jet_pt_unfolding,unfolding_jetpt_binning);
    ...
    gPad->SetLogx(1);
    gPad->SetLogy(1);
    if (do_print) c->Print(Form("./plots/unfolded2d_niter%i_ratio_logbinning_ct.pdf",niter));
    ...
    gPad->SetLogx(0);
    gPad->SetLogy(1);
    if (do_print) c->Print(Form("./plots/unfolded2d_niter%i_ratio_linbinning_ct.pdf",niter));
    ...
    if (do_print) c->Print(Form("./plots/paircorre2c_niter%i_linbinning_2dunf_ct.pdf",niter));
    ...
    if (do_print) c->Print(Form("./plots/paircorrtau_niter%i_logbinning_2dunf_ct.pdf",niter));
    ...
    if (do_print) c->Print(Form("./plots/paircorre2c_niter%i_logbinning_2dunf_ct.pdf",niter));
    ...
    if (compare_to_nominal)
    {
        ...
        gPad->SetLogx(1);
        gPad->SetLogy(1);
        if (do_print) c->Print(Form("./plots/corrpseudata_data_comp_niter%i_ratio_logbinning.pdf",niter));
    }
    ...
    if (compare_to_truth)
    {
        ...
        gPad->SetLogx(1);
        gPad->SetLogy(1);
        if (do_print) c->Print(Form("./plots/closuretest_niter%i_ratio_logbinning.pdf",niter));
    }
}
