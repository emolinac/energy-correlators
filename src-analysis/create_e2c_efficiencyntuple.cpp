...
//                {   
//                    if(mcrecotree->Jet_Dtr_TRUE_KEY[h_index]==mcrecotree->Jet_mcjet_dtrKeys[h_subindex]) {key_match++; key_match_index = h_subindex;}
//                }
                key_match++;
            ...
            vars_reco[13] = mcrecotree->Jet_mcjet_nmcdtrs;
            vars_reco[14] = (mcrecotree->Jet_Dtr_TRUE_ETA[h_index]==-999) ? -999 : rapidity(mcrecotree->Jet_Dtr_TRUE_E[h_index],mcrecotree->Jet_Dtr_TRUE_PZ[h_index]);
            vars_reco[15] = (mcrecotree->Jet_Dtr_TRUE_ETA[h_index]==-999) ? -999 : mcrecotree->Jet_Dtr_TRUE_ETA[h_index];
            vars_reco[16] = (mcrecotree->Jet_Dtr_TRUE_ETA[h_index]==-999) ? -999 : mcrecotree->Jet_Dtr_TRUE_PHI[h_index];
            vars_reco[17] = Jet_4vector->DeltaR(*h_4vector);            
            vars_reco[18] = key_match;
        ...
        for(int h_index = 0 ; h_index < mcrecotree->Jet_mcjet_nmcdtrs ; h_index++)
        {
            ...
            vars_mc[5]  = mcrecotree->Jet_PT/1000.;
