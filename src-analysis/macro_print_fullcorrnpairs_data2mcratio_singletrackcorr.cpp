...
void macro_print_fullcorrnpairs_data2mcratio_singletrackcorr(int niter = 15, bool do_print = true)
{
        ...
        for(int bin = 0 ; bin < nbin_jet_pt ; bin ++) {
                ...
                hdata2mc_ratio[bin]->Divide(hcorr_npairs[bin],hmc[bin],1,1);
        ...
        c->Print("./plots/data2mcratio_npairs_multiplicity_fullconditions_jetid_eventweightapplied.pdf");
}