...
void macro_print_fullcorreec_data2mc_altbinning(int niter = 4, bool apply_unfolding = true, bool apply_jet_unfolding = true)
{
        ...
        TH2D* hpurcorr = new TH2D("hpurcorr","",nbin_rl_altlogbinning_unfolding,unfolding_rl_altlogbinning,nbin_jet_pt_unfolding,unfolding_jet_pt_binning);
        TH2D* hmeas    = new TH2D("hmeas"   ,"",nbin_rl_altlogbinning_unfolding,unfolding_rl_altlogbinning,nbin_jet_pt_unfolding,unfolding_jet_pt_binning);
        TH2D* htrue    = new TH2D("htrue"   ,"",nbin_rl_altlogbinning_unfolding,unfolding_rl_altlogbinning,nbin_jet_pt_unfolding,unfolding_jet_pt_binning);
        ...
        TH2D* hunfolded_ratio     = new TH2D("hunfolded_ratio"  ,"",nbin_rl_altlogbinning_unfolding,unfolding_rl_altlogbinning,nbin_jet_pt_unfolding,unfolding_jet_pt_binning);
        TH2D* hpuritycorrected    = new TH2D("hpuritycorrected" ,"",nbin_rl_altlogbinning_unfolding,unfolding_rl_altlogbinning,nbin_jet_pt_unfolding,unfolding_jet_pt_binning);
        TH2D* hpuritycorrected2   = new TH2D("hpuritycorrected2","",nbin_rl_altlogbinning_unfolding,unfolding_rl_altlogbinning,nbin_jet_pt_unfolding,unfolding_jet_pt_binning);
        ...
        for (int bin = 0 ; bin < nbin_jet_pt ; bin++) {
                ...
                hcorr_eec[bin] = new TH1F(Form("hcorr_eec%i",bin),"", nbin_rl_altlogbinning, rl_altlogbinning);
        ...
        for(int bin = 0 ; bin < nbin_jet_pt ; bin++) {
                hmc[bin]     = new TH1F(Form("hmc[%i]", bin)    ,"",nbin_rl_altlogbinning,rl_altlogbinning);
        ...
        c->Print(Form("./plots/data2mc_eec_paircorr_fullsim_corr-smoothed_unf-%s-smoothed_unfjet-%s-smoothed_altbinning_alldata.pdf",(apply_unfolding)?"yes":"no",(apply_jet_unfolding)?"yes":"no"));
}