...
std_output_name="histos_3dpaircorr_rl_jetpt_weightpt_eec_jes_jer.root"
...
for ((i=0 ; i<${niter_jer} ; i++)); do
        root -b -q "macro_print_histocorreec_rl_jetpt_weightpt.cpp(${niter_unf},${niter_jet_unf},\"--get-jes-jer\",${i})"

        outfile_name="histos_eec_3dcorr_rl_jetpt_weightpt_niter${niter_unf}_niterjet${niter_jet_unf}--get-jes-jer"
