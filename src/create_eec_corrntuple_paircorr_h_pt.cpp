...
int main()
{
        ...
        // Create output file
        TFile* fout = new TFile((output_folder + namef_ntuple_eec_paircorr_h1h2).c_str(),"RECREATE");
        ...
        // //DELETE LATER
        TH2F* hnum_pur    = new TH2F("hnum_pur"   , "", ic_p_nbins,ic_p_binning, ic_p_nbins, ic_p_binning);
        TH2F* hden_pur    = new TH2F("hden_pur"   , "", ic_p_nbins,ic_p_binning, ic_p_nbins, ic_p_binning);
        TH2F* hpurity     = new TH2F("hpurity"    , "", ic_p_nbins,ic_p_binning, ic_p_nbins, ic_p_binning);
        TH2F* hnum_eff    = new TH2F("hnum_eff"   , "", ic_p_nbins,ic_p_binning, ic_p_nbins, ic_p_binning);
        TH2F* hden_eff    = new TH2F("hden_eff"   , "", ic_p_nbins,ic_p_binning, ic_p_nbins, ic_p_binning);
        TH2F* hefficiency = new TH2F("hefficiency", "", ic_p_nbins,ic_p_binning, ic_p_nbins, ic_p_binning);
        ...
        ntuple_purity->Project("hnum_pur", "h2_p:h1_p", pair_matching_cut);
        ntuple_purity->Project("hden_pur", "h2_p:h1_p");
        ntuple_efficiency_reco->Project("hnum_eff", "h2_p_truth:h1_p_truth", pair_matching_cut);
        ntuple_efficiency_mc->Project("hden_eff", "h2_p:h1_p");
        ...
        // DELETE LATER
        TH2F* hnum_pur_eqcharge    = new TH2F("hnum_pur_eqcharge"   , "", ic_p_nbins,ic_p_binning, ic_p_nbins, ic_p_binning);
        TH2F* hden_pur_eqcharge    = new TH2F("hden_pur_eqcharge"   , "", ic_p_nbins,ic_p_binning, ic_p_nbins, ic_p_binning);
        TH2F* hpurity_eqcharge     = new TH2F("hpurity_eqcharge"    , "", ic_p_nbins,ic_p_binning, ic_p_nbins, ic_p_binning);
        TH2F* hnum_eff_eqcharge    = new TH2F("hnum_eff_eqcharge"   , "", ic_p_nbins,ic_p_binning, ic_p_nbins, ic_p_binning);
        TH2F* hden_eff_eqcharge    = new TH2F("hden_eff_eqcharge"   , "", ic_p_nbins,ic_p_binning, ic_p_nbins, ic_p_binning);
        TH2F* hefficiency_eqcharge = new TH2F("hefficiency_eqcharge", "", ic_p_nbins,ic_p_binning, ic_p_nbins, ic_p_binning);
        
        TH2F* hnum_pur_neqcharge    = new TH2F("hnum_pur_neqcharge"   , "", ic_p_nbins,ic_p_binning, ic_p_nbins, ic_p_binning);
        TH2F* hden_pur_neqcharge    = new TH2F("hden_pur_neqcharge"   , "", ic_p_nbins,ic_p_binning, ic_p_nbins, ic_p_binning);
        TH2F* hpurity_neqcharge     = new TH2F("hpurity_neqcharge"    , "", ic_p_nbins,ic_p_binning, ic_p_nbins, ic_p_binning);
        TH2F* hnum_eff_neqcharge    = new TH2F("hnum_eff_neqcharge"   , "", ic_p_nbins,ic_p_binning, ic_p_nbins, ic_p_binning);
        TH2F* hden_eff_neqcharge    = new TH2F("hden_eff_neqcharge"   , "", ic_p_nbins,ic_p_binning, ic_p_nbins, ic_p_binning);
        TH2F* hefficiency_neqcharge = new TH2F("hefficiency_neqcharge", "", ic_p_nbins,ic_p_binning, ic_p_nbins, ic_p_binning);
        
        ntuple_purity->Project("hnum_pur_eqcharge", "h2_p:h1_p",pair_matching_cut + "eq_charge>1");
        ntuple_purity->Project("hden_pur_eqcharge", "h2_p:h1_p","eq_charge>1");
        ntuple_efficiency_reco->Project("hnum_eff_eqcharge", "h2_p_truth:h1_p_truth", pair_matching_cut + "eq_charge>1");
        ntuple_efficiency_mc->Project("hden_eff_eqcharge", "h2_p:h1_p","eq_charge>1");

        ntuple_purity->Project("hnum_pur_neqcharge", "h2_p:h1_p",pair_matching_cut + "eq_charge<-1");
        ntuple_purity->Project("hden_pur_neqcharge", "h2_p:h1_p","eq_charge<-1");
        ntuple_efficiency_reco->Project("hnum_eff_neqcharge", "h2_p_truth:h1_p_truth", pair_matching_cut + "eq_charge<-1");
        ntuple_efficiency_mc->Project("hden_eff_neqcharge", "h2_p:h1_p","eq_charge<-1");
        ...
        for (int i = 1; i <= hpurity->GetNbinsX(); ++i) {
                for (int j = 1; j <= hpurity->GetNbinsY(); ++j) {
                        ...
                        latex.DrawLatex(x, y, Form("%.2f", content));
                }
        }
        hpurity->SetTitle("Purity Correction;p_{T,h_{1}}(GeV);p_{T,h_{2}}(GeV)");
        ...
        gPad->SetLogx(1);
        gPad->SetLogy(1);
        c->Print("../src-analysis/plots/pair_purity_correction_h1h2pt.pdf");
        ...
        hefficiency->SetTitle("Efficiency Correction;p_{T,h_{1}}(GeV);p_{T,h_{2}}(GeV)");
        ...
        gPad->SetLogx(1);
        gPad->SetLogy(1);
        c->Print("../src-analysis/plots/pair_efficiency_correction_h1h2pt.pdf");
        ...
        for (int evt = 0 ; evt < datatree_2016->fChain->GetEntries() ; evt++) {
                ...
                for (int h1_index = 0 ; h1_index < datatree_2016->Jet_NDtr ; h1_index++) {
                        ...
                        for (int h2_index = h1_index+1 ; h2_index < datatree_2016->Jet_NDtr ; h2_index++) {
                                ...
                                double purity           = hpurity->GetBinContent(hpurity->FindBin(h1_4vector->Pt(),h2_4vector->Pt()));        
                                double efficiency       = hefficiency->GetBinContent(hefficiency->FindBin(h1_4vector->Pt(),h2_4vector->Pt()));
                                double purity_error     = hpurity->GetBinError(hpurity->FindBin(h1_4vector->Pt(),h2_4vector->Pt()));        
                                double efficiency_error = hefficiency->GetBinError(hefficiency->FindBin(h1_4vector->Pt(),h2_4vector->Pt()));

                                double nreco_ok  = hnum_pur->GetBinContent(hnum_pur->FindBin(h1_4vector->Pt(),h2_4vector->Pt()));
                                double nreco     = hden_pur->GetBinContent(hden_pur->FindBin(h1_4vector->Pt(),h2_4vector->Pt()));
                                double ntruth_ok = hnum_eff->GetBinContent(hnum_eff->FindBin(h1_4vector->Pt(),h2_4vector->Pt()));
                                double ntruth    = hden_eff->GetBinContent(hden_eff->FindBin(h1_4vector->Pt(),h2_4vector->Pt()));
