...
void macro_print_norme2c_rl_data_jetpt()
{
    ...
    TH1F* h_1 = new TH1F("h_1","",Nbin_R_L, binning);
    TH1F* h_2 = new TH1F("h_2","",Nbin_R_L, binning);
    TH1F* h_3 = new TH1F("h_3","",Nbin_R_L, binning);
    h_1->Sumw2();
    h_2->Sumw2();
    h_3->Sumw2();
    ...
    c->Draw();
    ntuple->Draw("R_L>>h_1",e2c_jetpt_cut[0],"goff");
    ntuple->Draw("R_L>>h_2",e2c_jetpt_cut[1],"goff");
    ntuple->Draw("R_L>>h_3",e2c_jetpt_cut[2],"goff");
