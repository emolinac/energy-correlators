...
void macro_print_rl_resolution()
{
    ...
    ntuple_dtrmatch->Project("hres","R_L_truth-R_L",pair_cut+"R_L!=0&&R_L_truth!=-999");
    ...
    line1->DrawLine(-resolution,0,-resolution,hres->GetMaximum());
    line2->DrawLine(resolution,0,resolution,hres->GetMaximum());
