...
void macro_print_fullcorre2c_paircorr_2dunf(int niter = 20)
{
    ...
    gPad->SetLogx(1);
    gPad->SetLogy(1);
    c->Print(Form("./plots/unfolded2d_initer%i_ratio_linbinning.pdf",niter));
    ...
    gPad->SetLogx(0);
    gPad->SetLogy(1);
    c->Print(Form("./plots/unfolded2d_initer%i_ratio_logbinning.pdf",niter));
    ...
    c->Print(Form("./plots/fullpaircorre2c_niter%i_logbinning_2dunf.pdf",niter));
    ...
    c->Print(Form("./plots/fullpaircorre2c_niter%i_linbinning_2dunf.pdf",niter));
}
