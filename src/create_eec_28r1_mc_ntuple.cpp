...
#include "TZJetsMC.h"
#include "TZJetsMC.C"
#include "TZJetsMCReco28r1.h"
#include "TZJetsMCReco28r1.C"
#include "TROOT.h"
#include "TNtuple.h"
#include "TFile.h"
...
{
        // Create output file
        TFile* fout = new TFile((output_folder + namef_ntuple_mc_eec_28r1).c_str(),"RECREATE");
        
        // Declare the TTrees to be used to build the ntuples
        TZJetsMC* mctree = new TZJetsMC();
        TZJetsMCReco28r1* mcrecotree = new TZJetsMCReco28r1();
