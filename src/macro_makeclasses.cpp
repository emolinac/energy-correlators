...
void macro_makeclasses()
{
    ...
    TChain* chain5 = new TChain("mcjettuple/MCJetTree");  
    ...
    chain5->Add((input_folder+"Zjet_MC_Sim09l_2016_MD_03112025_full.root").c_str());
    chain5->Add((input_folder+"Zjet_MC_Sim09l_2016_MU_03112025_full.root").c_str());
    
    chain1->MakeClass("TZJetsMC");
    chain2->MakeClass("TZJetsMCReco");
    chain3->MakeClass("TZJetsData");
    chain4->MakeClass("TZJetsMCAT");
    chain5->MakeClass("TZJetsMCRef");
}
