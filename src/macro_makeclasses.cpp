...
void macro_makeclasses()
{
    ...
    chain1->Add((input_folder+"Zjet_MC_Sim09l_2016_MD_03272025.root").c_str());
    chain1->Add((input_folder+"Zjet_MC_Sim09l_2016_MU_03272025.root").c_str());
    chain2->Add((input_folder+"Zjet_MC_Sim09l_2016_MD_03272025.root").c_str());
    chain2->Add((input_folder+"Zjet_MC_Sim09l_2016_MU_03272025.root").c_str());
