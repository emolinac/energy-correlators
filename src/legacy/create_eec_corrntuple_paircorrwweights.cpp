...
int main()
{
        ...
        // Create output file
        TFile* fout = new TFile((output_folder + namef_ntuple_eec_paircorrwweights).c_str(),"RECREATE");
        ...
        gPad->SetLogx(1);
        gPad->SetLogy(1);
        c->Print("../src-analysis/plots/pair_purity_correction_smooth_wweights.pdf");
        ...
        gPad->SetLogx(1);
        gPad->SetLogy(1);
        c->Print("../src-analysis/plots/pair_efficiency_correction_smooth_wweights.pdf");
        ...
        gPad->SetLogx(1);
        gPad->SetLogy(1);
        c->Print("../src-analysis/plots/pair_purity_correction_eqcharge_smooth_wweights.pdf");
        ...
        gPad->SetLogx(1);
        gPad->SetLogy(1);
        c->Print("../src-analysis/plots/pair_efficiency_correction_eqcharge_smooth_wweights.pdf");
        ...
        gPad->SetLogx(1);
        gPad->SetLogy(1);
        c->Print("../src-analysis/plots/pair_purity_correction_neqcharge_smooth_wweights.pdf");
        ...
        gPad->SetLogx(1);
        gPad->SetLogy(1);
        c->Print("../src-analysis/plots/pair_efficiency_correction_neqcharge_smooth_wweights.pdf");
