...
int main()
{
        ...
        TFile* fcorrections_pair = new TFile((output_folder + namef_ntuple_e2c_paircorrections_inclusive).c_str());
        ...
        // Create output file
        TFile* fout = new TFile((output_folder + namef_ntuple_e2c_paircorr_inclusive).c_str(),"RECREATE");
