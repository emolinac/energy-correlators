...
void macro_print_purityefficiencycorrunfolded_corre2c(int niter = 5)
{
    ...
    TH2D* hpureffcorrected  = new TH2D("hpureffcorrected","",Nbin_R_L+2,unfolding_rl_binning,Nbin_jet_pt+2,unfolding_jetpt_binning);
    TH2D* hpureffcorrected2 = new TH2D("hpureffcorrected2","",Nbin_R_L+2,unfolding_rl_binning,Nbin_jet_pt+2,unfolding_jetpt_binning);
    ntuple_data->Project("hpureffcorrected" ,"jet_pt:R_L",full_corr_singletrack);
    ntuple_data->Project("hpureffcorrected2","jet_pt:R_L",full_corr_singletrack);
    
    RooUnfoldBayes unfold(response, hpureffcorrected, niter);
    TH2D* hunfolded_bayes = (TH2D*) unfold.Hunfold();

    hunfolded_ratio->Divide(hunfolded_bayes,hpureffcorrected2,1,1);
    ...
    c->Print("./plots/corr_norme2c_weightpt_unfolded2d_inputpureffcorr_eqsizebinning.pdf");
}
