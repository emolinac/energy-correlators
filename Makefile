...
${BIN}/create_e2c_unfoldingntuple: ${SRC_C}/create_e2c_unfoldingntuple.cpp
	${CXX} ${ROOTCFLAGS} ${SRC_C}/create_e2c_unfoldingntuple.cpp -I${INC} ${ROOTLIBS} -o ${BIN}/create_e2c_unfoldingntuple
