...
# all: ${BIN}/create_eec_mc_ntuple

# all: ${BIN}/create_jet_purityntuple ${BIN}/create_jet_efficiencyntuple \
# 	 ${BIN}/create_eec_corrntuple_paircorr \
# 	 ${BIN}/create_eec_mc_ntuple ${BIN}/create_hadron_ntuple \
# 	 ${BIN}/create_eec_paircorrectionsntuple \
# 	 ${BIN}/create_eec_corrntuple ${BIN}/create_eec_hadroncorrectionsntuple \
# 	 ${BIN}/create_mcreco_hadronmultiplicity_corrntuple ${BIN}/create_eec_mcrecocorrntuple \
# 	 ${BIN}/create_eec_mcrecocorrntuple_paircorr ${BIN}/create_eec_mcrecocorrntuple_2d

all: ${BIN}/create_jet_purityntuple ${BIN}/create_jet_efficiencyntuple \
	 ${BIN}/create_eec_corrntuple_paircorr ${BIN}/create_eec_corrntuple_paircorr3d \
	 ...
	 ${BIN}/create_eec_paircorrectionsntuple_jes ${BIN}/create_eec_paircorrectionsntuple_jer \
	 ${BIN}/create_eec_corrntuple ${BIN}/create_eec_hadroncorrectionsntuple \
	 ${BIN}/create_mcreco_hadronmultiplicity_corrntuple ${BIN}/create_eec_mcrecocorrntuple \
	 ${BIN}/create_eec_mcrecocorrntuple_paircorr ${BIN}/create_eec_mcrecocorrntuple_2d

${BIN}/create_eec_mcrecocorrntuple_paircorr: ${SRC}/create_eec_mcrecocorrntuple_paircorr.cpp
	${CXX} ${ROOTCFLAGS} ${SRC}/create_eec_mcrecocorrntuple_paircorr.cpp -I${INC} ${ROOTLIBS} -o ${BIN}/create_eec_mcrecocorrntuple_paircorr

${BIN}/create_eec_mcrecocorrntuple: ${SRC}/create_eec_mcrecocorrntuple.cpp
	${CXX} ${ROOTCFLAGS} ${SRC}/create_eec_mcrecocorrntuple.cpp -I${INC} ${ROOTLIBS} -o ${BIN}/create_eec_mcrecocorrntuple

${BIN}/create_eec_mcrecocorrntuple_2d: ${SRC}/create_eec_mcrecocorrntuple_2d.cpp
	${CXX} ${ROOTCFLAGS} ${SRC}/create_eec_mcrecocorrntuple_2d.cpp -I${INC} ${ROOTLIBS} -o ${BIN}/create_eec_mcrecocorrntuple_2d

${BIN}/create_mcreco_hadronmultiplicity_corrntuple: ${SRC}/create_mcreco_hadronmultiplicity_corrntuple.cpp
	${CXX} ${ROOTCFLAGS} ${SRC}/create_mcreco_hadronmultiplicity_corrntuple.cpp -I${INC} ${ROOTLIBS} -o ${BIN}/create_mcreco_hadronmultiplicity_corrntuple
...
${BIN}/create_eec_paircorrectionsntuple_jes: ${SRC}/create_eec_paircorrectionsntuple_jes.cpp
	${CXX} ${ROOTCFLAGS} ${SRC}/create_eec_paircorrectionsntuple_jes.cpp -I${INC} ${ROOTLIBS} -o ${BIN}/create_eec_paircorrectionsntuple_jes

${BIN}/create_eec_paircorrectionsntuple_jer: ${SRC}/create_eec_paircorrectionsntuple_jer.cpp
	${CXX} ${ROOTCFLAGS} ${SRC}/create_eec_paircorrectionsntuple_jer.cpp -I${INC} ${ROOTLIBS} -o ${BIN}/create_eec_paircorrectionsntuple_jer
...
${BIN}/create_eec_corrntuple_paircorr3d: ${SRC}/create_eec_corrntuple_paircorr3d.cpp
	${CXX} ${ROOTCFLAGS} ${SRC}/create_eec_corrntuple_paircorr3d.cpp -I${INC} ${ROOTLIBS} -o ${BIN}/create_eec_corrntuple_paircorr3d
