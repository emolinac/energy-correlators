...
void macro_print_recotruth_rl()
{
    ...
    ntuple_dtrmatch->Project("hres","deltaR_h1",pair_all_cut);
    ...
    ntuple_dtrmatch->Project("hsel","deltaR_h1",Form(pair_all_cut+"deltaR_h1<%f",R_match_max));
    ...
    c->Print("../plots/RL_hrecotruth.pdf");
}