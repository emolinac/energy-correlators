...
void macro_print_singlepurity_eta_phi()
{
    ...
    ntuple_dtrmatch->Project("hsig","h_eta:h_phi",single_signal_cut);
    ntuple_dtrmatch->Project("hall","h_eta:h_phi",pair_cut         );
    ...
    hpurity->SetTitle(";#phi;#eta");

    c->Print("../../plots/purity/singlehadron_purity_eta_phi.pdf");
}