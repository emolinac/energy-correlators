...
void macro_print_singlepurity_eta()
{
    ...
    TH1F* hsig    = new TH1F("hsig"   ,"",ndim_corr,eta_min,eta_max);
    TH1F* hall    = new TH1F("hall"   ,"",ndim_corr,eta_min,eta_max);
    TH1F* hpurity = new TH1F("hpurity","",ndim_corr,eta_min,eta_max);
    hsig->Sumw2();
    hall->Sumw2();
    hpurity->Sumw2();
    ...
    ntuple_dtrmatch->Project("hsig","h_eta",single_signal_cut);
    ntuple_dtrmatch->Project("hall","h_eta",pair_cut         );
    ...
    hpurity->SetTitle(";#eta;Single Hadron Purity");

    c->Print("../../plots/purity/singlehadron_purity_eta.pdf");
}