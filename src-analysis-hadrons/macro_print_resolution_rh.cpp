...
void macro_print_resolution_rh()
{
        ...
        TH1F* hratio = new TH1F("hratio","",1000,0.9,1.1);
        hres->Sumw2();
        hratio->Sumw2();
        ...
        ntuple_dtrmatch->Project("hres"  ,"R_h_reco-R_h_truth",pair_cut+"R_h_truth!=-999");
        ntuple_dtrmatch->Project("hratio","R_h_reco/R_h_truth",pair_cut+"R_h_truth!=-999");
        ...
        hres->Draw();
        hres->SetTitle(";#Delta R_{h}(Reco,Truth);");
        ...
        c->Print("./plots/resolution_rh.pdf");

        hratio->Draw();
        hratio->SetTitle(";R_{h}(Reco)/R_{h}(Truth);");
        ...
        // gPad->SetLogy(0);
        c->Print("./plots/resolution_rh_ratio.pdf");
}