...
std::string mother_folder = "/home/emolinac/Documents/work/lhcb/energy-correlators-rapidity/";
std::string output_folder = mother_folder+"output-files/";
std::string input_folder  = "/home/emolinac/Documents/work/lhcb/z-jets/";
