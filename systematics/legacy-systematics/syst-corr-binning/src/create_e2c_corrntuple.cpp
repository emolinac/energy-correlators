...
int main()
{
  ...
  // Hadron corrections
  TH3F* hnum_pur = new TH3F("hnum_pur","",ic_p_nbins,ic_p_binning,sl_eta_nbins,sl_eta_binning,nbin_jetpt_corrections,jetpt_corrections_binning);
  TH3F* hden_pur = new TH3F("hden_pur","",ic_p_nbins,ic_p_binning,sl_eta_nbins,sl_eta_binning,nbin_jetpt_corrections,jetpt_corrections_binning);
  TH3F* hpurity  = new TH3F("hpurity" ,"",ic_p_nbins,ic_p_binning,sl_eta_nbins,sl_eta_binning,nbin_jetpt_corrections,jetpt_corrections_binning);
  TH3F* hnum_eff    = new TH3F("hnum_eff"   ,"",ic_p_nbins,ic_p_binning,sl_eta_nbins,sl_eta_binning,nbin_jetpt_corrections,jetpt_corrections_binning);
  TH3F* hden_eff    = new TH3F("hden_eff"   ,"",ic_p_nbins,ic_p_binning,sl_eta_nbins,sl_eta_binning,nbin_jetpt_corrections,jetpt_corrections_binning);
  TH3F* hefficiency = new TH3F("hefficiency","",ic_p_nbins,ic_p_binning,sl_eta_nbins,sl_eta_binning,nbin_jetpt_corrections,jetpt_corrections_binning);
  ...
  ntuple_purity->Project("hden_pur","jet_pt:h_eta:h_p",pair_cut         );
