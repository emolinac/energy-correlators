...
void macro_print_singleefficiency_eta()
{
    ...
    TH1F* hefficiency = new TH1F("hefficiency","",ndim_corr,eta_min,eta_max);
    hsig->Sumw2();
    hall->Sumw2();
    hefficiency->Sumw2();
    ...
    ntuple_mcreco->Project("hsig","h_eta",single_signal_cut);
    ntuple_mc->Project("hall","h_eta",pair_cut         );
