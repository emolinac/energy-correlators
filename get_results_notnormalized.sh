...
root -b -q -l "macro_print_fullcorreec_paircorr_2dunf_ct_niter.cpp(4, 10, true, true)"
...
root -b -q -l "macro_print_fullcorreec_paircorr_2dunf_shapect_niter.cpp(4, 1, true, true)"
...
root -b -q -l "macro_print_deviation_from_nominal.cpp(false,true,6)"
