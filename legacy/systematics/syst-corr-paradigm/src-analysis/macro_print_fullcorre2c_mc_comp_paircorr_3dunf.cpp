...
void macro_print_fullcorreec_mc_comp_paircorr_3dunf(int niter = nominal_niter, bool do_print = true, bool integrate_weight = true)
{
    ...
    if (do_print) c->Print(Form("./plots/paircorreec_niter%i_mccomp_3dunf_wintegrated%s.pdf",niter,integrate_weight?"true":"false"));
    ...
    if (do_print) c->Print(Form("./plots/paircorreec_niter%i_mccomp_logscale_3dunf_wintegrated%s.pdf",niter,integrate_weight?"true":"false"));
    ...
    if (do_print) c->Print(Form("./plots/paircorreec_niter%i_mccomp_linbinning_3dunf_wintegrated%s.pdf",niter,integrate_weight?"true":"false"));
}