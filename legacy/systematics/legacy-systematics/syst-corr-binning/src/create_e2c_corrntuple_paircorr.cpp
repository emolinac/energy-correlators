...
int main()
{
  ...
  TFile* fefficiency     = new TFile((output_folder + namef_ntuple_eec_pairefficiency).c_str());
  ...
  // Hadron corrections
  TH2F* hnum_pur    = new TH2F("hnum_pur"   ,"",nbin_rl_altlogbin,rl_altlogbinning,nbin_jet_pt_corrections,jet_pt_corrections_binning);
  TH2F* hden_pur    = new TH2F("hden_pur"   ,"",nbin_rl_altlogbin,rl_altlogbinning,nbin_jet_pt_corrections,jet_pt_corrections_binning);
  TH2F* hpurity     = new TH2F("hpurity"    ,"",nbin_rl_altlogbin,rl_altlogbinning,nbin_jet_pt_corrections,jet_pt_corrections_binning);
  TH2F* hnum_eff    = new TH2F("hnum_eff"   ,"",nbin_rl_altlogbin,rl_altlogbinning,nbin_jet_pt_corrections,jet_pt_corrections_binning);
