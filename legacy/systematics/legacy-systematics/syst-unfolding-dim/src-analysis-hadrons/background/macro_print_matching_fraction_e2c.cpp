...
void macro_print_matching_fraction_eec()
{
    ...
    l->AddEntry(hratio_matched      ,"\% eec Matched && #Delta R<0.02"  ,"lpf");
    l->AddEntry(hratio_halfunmatched,"\% eec One unmatched","lpf");
    l->AddEntry(hratio_unmatched    ,"\% eec Both unmatched","lpf");
    l->Draw("SAME");
