...
std::string variation_folder = "/home/esteban/Documents/umich-work/lhcb/energy-correlator-priortracks/output-files/";
...
void macro_print_leptonpair_frac()
{
    ...
    TH1F* hnominal   = new TH1F("hnominal"  ,"",nbin_rl_nominal,rl_binning);
    TH1F* hvariation = new TH1F("hvariation","",nbin_rl_nominal,rl_binning);
    TH1F* hratio     = new TH1F("hratio"    ,"",nbin_rl_nominal,rl_binning);
    ...
    hratio->Draw();
    gPad->SetLogx(1);
    hratio->SetTitle(";R_{L};Hadrons/prior");
}