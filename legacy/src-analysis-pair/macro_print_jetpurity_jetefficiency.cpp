...
void macro_print_jetpurity_jetefficiency()
{
    ...
    TH1F* hsig_purity    = new TH1F("hsig_purity"   ,"",nbin_jet_pt+2,unfolding_jet_pt_binning);
    TH1F* hall_purity    = new TH1F("hall_purity"   ,"",nbin_jet_pt+2,unfolding_jet_pt_binning);
