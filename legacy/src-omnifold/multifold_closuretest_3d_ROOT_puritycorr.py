...
#     hunfol_jet_pt.Fill(mc_set_validate[entry,1],of_weights[entry]*mc_set_validate[entry,3])
...
for entry in range(len(of_weights)-1):
    ...
    htruth_jet_pt.Fill(mc_truth[entry,1])
    hunfol_jet_pt.Fill(mc_unfolded[entry,1],of_weights[entry])
