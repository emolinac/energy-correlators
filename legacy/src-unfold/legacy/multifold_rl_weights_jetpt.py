...
_,_,_ = ax33.hist(theta0_G[:,2]       ,bins=np.linspace(0,0.125,25),color='blue',histtype="step",label="MC, true",lw="2")
_,_,_ = ax33.hist(theta0_S[:,2]       ,bins=np.linspace(0,0.125,25),color='green',histtype="step",label="MC, reco",lw="2")
_,_,_ = ax33.hist(theta_unknown_S[:,2],bins=np.linspace(0,0.125,25),color='orange',histtype="step",label="Data, reco",lw="2")
